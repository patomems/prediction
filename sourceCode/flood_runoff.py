...
def flood_runoff_forecast(filename, wtd):
    def import_data():
        raw_data_df = pd.read_excel('/home/boyking/project /Rainfall_Flood/sourceCode/data/' + filename + '.xlsx', header=0)
        return raw_data_df
    ...
    for i in range(1, len(raw_data_df.columns)):
        ...
        def making_dataset(i=1):
            ...
            path = ('/home/boyking/project /Rainfall_Flood/sourceCode/trained/' + filename + '_flood_runoff')
            ...
            if wtd == 0:
                ...
                df4.to_csv('/home/boyking/project /Rainfall_Flood/sourceCode/data/forecast/' + filename + '_flood_runoff_forecast.csv', index=False)
                return df4
